...
fd = None
task_map = tasks_mem_create = regcmd_map = regcmd_mem_create = None
input_map = input_mem_create = weight_map = weight_mem_create = output_map = output_mem_create = None
