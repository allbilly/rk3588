...
QWORD_WINDOW = os.environ.get("RKNPU_QWORD_WINDOW", "2:923648:832")
...
class Capture:
    ...
    def handle(cls):
        ...
        gdb.execute(f"shell python3 /home/orangepi/rk3588/experimental/rknn/dump_rknpu_task_gems.py --qword-window {QWORD_WINDOW} 1 2 3 4 5 6", to_string=False)
